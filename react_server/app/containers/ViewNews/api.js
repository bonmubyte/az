...
export const viewPostApi = (id, name_payload) => axios.post(`/api/post/add_friend/?pk=${id}`, name_payload);
export const updatePostApi = (id, payload) => axios.post(`/api/post/${id}/`, payload);
export const comment = (data) => axios.post(`/api/comment/`, data);
export const commentsApi = (id) => axios.get(`/api/comment/?post=${id}&kind=0`);
...
export const fetchReplies = (commentID) => axios.get(`/api/comment-reply/?replied_reply=${commentID}`);
...
export const deletePost = (id) => axios.post(`/api/post/delete_post/?pk=${id}`);
...
export const deletePostReaction = (data) => axios.post(`/api/post-reaction/delete_post_reaction/?pk=${data.id}`, data);
// export const viewPostApi = (id,name_payload) => axios.post(`/api/post/add_friend/?pk=${id}`,name_payload);
export const fetchCommentVotes = (commentID) => axios.get(`/api/comment-vote/?comment=${commentID}`);
export const fetchReplyVotes = (replyID) => axios.get(`/api/reply-vote/?reply=${replyID}`);
