...
import { LOGOUT_USER } from '../App/constants.js';
				...
				<Row justify="center">
					<Col span={8} offset={8}>
						<div className="wrapper">
							<img class="center" src={'https://i.imgur.com/Yfm7pBM.png'} style={{ height: 50, width: '200' }}  />
							<p><br></br>Welcome to Articlize!<br></br> Log in or Sign Up Below, <br></br> Or Visit <a href = "https://www.articlize.news/" target = "_blank">Our Company Page</a> to learn more!</p>
							<Form onSubmit={this.handleSubmit} className="login-form">
								...
								<FormItem>
									<Button type="secondary" style = {{backgroundColor: '#9e419b', color: '#ffffff'}} className="login-form-button" htmlType="submit">
